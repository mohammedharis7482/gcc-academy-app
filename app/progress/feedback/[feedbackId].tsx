...
export default function FeedbackDetailScreen() {
  ...
  return <AppScreen withTabBarClearance={false}><SubpageHeader title="Coach Feedback" subtitle={feedback.date} onBack={back} /><FeedbackDetailCard feedback={feedback} onAssessmentPress={dynamicFeedback?.mode === 'full-assessment' || !dynamicFeedback ? () => router.push({ pathname: '/progress/assessment/[assessmentId]', params: { assessmentId: feedback.assessmentId } }) : undefined} onLessonPress={() => router.push({ pathname: '/sessions/[sessionId]', params: { sessionId: feedback.recommendedLessonId } })} /></AppScreen>;
}
