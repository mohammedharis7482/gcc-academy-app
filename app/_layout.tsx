...
function AppNavigator() {
  ...
  return <Stack screenOptions={{ headerShown: false }}><Stack.Protected guard={isPlayer}><Stack.Screen name="(tabs)" /><Stack.Screen name="training/schedule" /><Stack.Screen name="progress/attendance" /><Stack.Screen name="progress/assessment/[assessmentId]" /><Stack.Screen name="progress/feedback/[feedbackId]" /><Stack.Screen name="sessions/[sessionId]" /><Stack.Screen name="updates/[updateId]" /><Stack.Screen name="profile/fees" /><Stack.Screen name="profile/settings" /><Stack.Screen name="profile/notifications" /><Stack.Screen name="profile/support" /><Stack.Screen name="profile/about" /><Stack.Screen name="profile/privacy" /><Stack.Screen name="profile/terms" /></Stack.Protected><Stack.Protected guard={isCoach}><Stack.Screen name="(coach)" /></Stack.Protected><Stack.Protected guard={isAdmin}><Stack.Screen name="(admin)" /></Stack.Protected><Stack.Protected guard={!isAuthenticated}><Stack.Screen name="(auth)" /></Stack.Protected></Stack>;
}
