...
export default function ProgressScreen() {
  ...
  const openSession = () => navigateOnce(() => router.push({ pathname: '/sessions/[sessionId]', params: { sessionId: dashboard.recommendedLesson.id } })); const openSkill = (skill: SkillRating) => navigateOnce(() => router.push({ pathname: '/progress/assessment/[assessmentId]', params: { assessmentId: latestFull?.id ?? latestAssessmentId, skillId: skill.key } })); const openFeedback = (feedback: ProgressFeedback) => navigateOnce(() => router.push({ pathname: '/progress/feedback/[feedbackId]', params: { feedbackId: feedback.id } }));
