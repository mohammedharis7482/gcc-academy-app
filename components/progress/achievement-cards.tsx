...
export function AchievementCards({ achievements }: { achievements: Achievement[] }) {
  ...
  if (!achievements.length) return <EmptyState compact icon="trophy-outline" title="No achievements yet" message="Player milestones will appear as development continues." />;
